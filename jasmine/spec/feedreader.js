...
$(function() {
    ...
    /* TODO: Test suite named "The menu" */
    ...
    /* TODO: Test suite named "Initial Entries" */
    describe('Initial Entries', function() {
        ...
        it('There is at least a single entry element within feed container', function(done) {
            let entry = document.querySelector('.feed .entry')[0];
            expect(entry).not.toBe(0);
            done();
        });
    });
    /* TODO: Test suite named "New Feed Selection"*/
